...
Filename    :   CustomOVRPlayerController.cs
...
/// attached to the CustomOVRPlayerController prefab, which has an OVRCameraController attached
/// to it. 
/// 
/// The controller will interact properly with a Unity scene, provided that the scene has
/// collision assigned to it. 
///
/// The CustomOVRPlayerController prefab has an empty GameObject attached to it called 
...
public class CustomOVRPlayerController : MonoBehaviour
{
  ...
  {   
    ...
    if(Controller == null)
      Debug.LogWarning("CustomOVRPlayerController: No CharacterController attached.");
    ...
    if(CameraControllers.Length == 0)
      Debug.LogWarning("CustomOVRPlayerController: No OVRCameraController attached.");
    else if (CameraControllers.Length > 1)
      Debug.LogWarning("CustomOVRPlayerController: More then 1 OVRCameraController attached.");
    else
    ...
    if(DirXform == null)
      Debug.LogWarning("CustomOVRPlayerController: ForwardDirection game object not found. Do not use.");
  }
